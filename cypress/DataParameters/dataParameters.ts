...
export const dataParameters: DataParameters = {
    ...
    Budget: {
        searchBudgetByBranch:[faker.helpers.arrayElement(['5'])].toString(),
        searchBudgetByNumber:[faker.helpers.arrayElement(['105560'])].toString(),
        budgetist: 'orcam',
        budgetAttendant: 'adm',
        recipeNumber:'425558',
        ...
        shippingMethod: ShippingMethod.SedexSC,
