...
export const dataParameters: DataParameters = {
    ...
    Recipe: {
        ...
        search: {
            ...
            initialDate: String(faker.date.between({ from: '2023-01-01T00:00:00.000Z', to: '2023-12-01T00:00:00.000Z' })),
            finalDate: String(faker.date.between({ from: '2023-12-02T00:00:00.000Z', to: '2023-12-20T00:00:00.000Z' })),
