...
export const dataParameters: DataParameters = {
    ...
    Budget: {
        confirmation: {
            ...
            cashierObservation: String([faker.helpers.arrayElement(['Teste'])]),
            detailedSale: true,
            paymentStatus: BudgetConfirmationPaymentStatus.NotPayed,
            address: 1,
            expeditionObservation: String([faker.helpers.arrayElement(['Teste'])]),
            ...
            generalObservation: String([faker.helpers.arrayElement(['Teste'])]),
