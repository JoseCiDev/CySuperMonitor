Feature: Envio automático de mensagens via WhatsApp para clientes
    ...
    # Cenário 3: Configuração para enviar mensagem em dois locais
    ...
    # Cenário 4: Configuração para não enviar mensagem em dois locais
    ...
    # Cenário 5: Confirmar pedido com cliente diferente de paciente
    ...
    # Cenário 6: Confirmar pedido com cliente de filiais de manipulados
    ...
    # Cenário 7: Confirmar pedido com cliente de injetáveis
    ...
    # Cenário 8: Cliente com mais de um cliente com o mesmo número de telefone
    ...
    # Cenário 9: Cliente sem número telefônico
