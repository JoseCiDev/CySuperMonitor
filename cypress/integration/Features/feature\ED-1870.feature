    ...
    @functional
    Feature: Apresentar endereço And forma de pagamento na tela de atendimento
    ...
    Background:
            ...
            @functional
            @payment_form
            Scenario Outline: Preencher endereço And pagar com sucesso
            Given que eu estou na tela de atendimento
            And eu seleciono a forma de pagamento <forma_de_pagamento> And envio link de pagamento ao cliente
            ...
            @functional
            @payment_form
            Scenario Outline: Preencher endereço, pagamento retorna tente novamente, preencher outro endereço And pagar com sucesso
            Given que eu estou na tela de atendimento
            ...
            | pix                | Rua B, 456, Cidade Y | Rua And, 202, Cidade V |
            | indefinido         | Rua C, 789, Cidade Z | Rua F, 303, Cidade U |

    # Tags para categorização dos cenários
    @functional
    Feature: reopening de atendimento And alteração do endereço
    ...
    Background:
            ...
            @functional
            @reopening
            Scenario Outline: Reabrir atendimento And verificar forma de pagamento And endereço
