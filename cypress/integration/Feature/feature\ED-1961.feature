Feature: Campanha SEMANA DO NUTRICIONISTA 2024
    ...
    @validacao @cliente_elegivel @produtos_validos
    ...
    @brinde @validacao_brinde @faixa_valores
    ...
    @alteracao_pedido @aumento_valor @brinde_mudanca
    ...
    @alteracao_pedido @diminuicao_valor @brinde_mudanca
    ...
    @alteracao_pedido @desconto_acrescimo @brinde_mudanca
    ...
    @alteracao_pedido @exclusao_produto @brinde_remocao
    ...
    @validacao @cliente_nao_elegivel
