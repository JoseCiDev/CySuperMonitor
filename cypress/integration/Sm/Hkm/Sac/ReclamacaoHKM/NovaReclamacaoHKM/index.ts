...
class NewReport {
    ...
    acessarAbaGeral(){
        cy.get(el.accessgeneraltab).click();
    ...
    preencherRelatoOrcamentoVinculado(){
        ...
        cy.get(el.linkedbudget).type('529754');
        cy.get(el.linkedbudgetHidden).invoke('attr', 'value', '529754');
    ...
    enviarRelato(){
        cy.get(el.registerreport).click();
        cy.get(el.savestory).click();
