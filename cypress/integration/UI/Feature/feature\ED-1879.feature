Feature: Envio automático de mensagens via WhatsApp para clientes
    ...
    Scenario Outline: Enviar mensagem para cliente que não é paciente
        ...
        Examples:
            | telefoneCliente | tipoCliente           | acaoOrçamento |
