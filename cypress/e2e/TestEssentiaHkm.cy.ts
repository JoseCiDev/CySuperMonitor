...
import { data } from '../fixtures/sm/hkm/nrorccdfil';
...
//ATENDIMENTO
import AtendimentoHKM from '../integration/sm/hkm/AtendimentoHKM';

//INCLUSAO
import InclusaoHKM from '../integration/sm/hkm/InclusaoHKM';

//CONFERENCIA ENTRADA
import ConferenciaEntradaHKM from '../integration/sm/hkm/ConferenciaEntradaHKM';
...
//SAC
import ComplaintHKM from '../integration/sm/hkm/SacHKM/ComplaintHKM';
import DoubtHKM from '../integration/sm/hkm/SacHKM/DoubtHKM';
import ComplimentHKM from '../integration/sm/hkm/SacHKM/ComplimentHKM';
import UnresolvedComplaintHKM from '../integration/sm/hkm/SacHKM/UnresolvedComplaintHKM';
...
describe('Teste Automatizado Essentia Group SuperMonitor', () => {
    ...
    const execSm = (tipo) => {
        ...
        return moduloSm[tipo] || moduloSm.backofficeHkm
    }


    execSm('backofficeHkm')
