...
dotenv.config();
// PEDIDO EM ANDAMENTO
var PedidoEmAndamento_1 = require("../integration/Atendimento/PedidoEmAndamento/PedidoEmAndamento");
//INCLUSAO
//CONFERENCIA ENTRADA
//LABORATORIO
//MONITORAMENTO
...
//BUSCAS
//CONFIGURACOES
describe('Teste Automatizado Essentia Group SuperMonitor', function () {
    before(function () {
    ...
    var execSm = function (tipo) {
        var moduloSm = {
            ...
            // },
            receita: {
                importarReceita: it('Importações de Receitas', function () {
                    // for (let i = 0; i < 10; i++) {
    ...
    var modulo = execSm(PedidoEmAndamento_1.PedidoEmAndamento);
});
